...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''This method creates a preprocessor object that applies transformations to numerical and categorical features.
        It returns a ColumnTransformer that applies a numerical pipeline and a categorical pipeline to the respective columns.'''
